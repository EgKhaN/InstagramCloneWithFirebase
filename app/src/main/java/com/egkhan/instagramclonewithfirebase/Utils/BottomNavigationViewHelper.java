...
import com.egkhan.instagramclonewithfirebase.Likes.LikesActivity;
import com.egkhan.instagramclonewithfirebase.Profile.ProfileActivity;
import com.egkhan.instagramclonewithfirebase.R;
import com.egkhan.instagramclonewithfirebase.Search.SearchActivity;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.ic_alert:
                        ...
                        break;
                    case R.id.ic_android: Intent intent5 = new Intent(context, ProfileActivity.class);//ACTIVITY_NUM =4;
